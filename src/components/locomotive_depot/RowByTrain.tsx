...
const CanClickClassName="m-1 flex items-center justify-center cursor-pointer rounded-2xl hover:text-primary hover:shadow-md hover:shadow-primary/30 hover:scale-110"
...
export const RowByTrain = ({
  ...
  return (
    <div className="grid grid-cols-17 gap-4   w-full border-b-2 border-gray-200 text-left ">
      ...
      <div className={CanClickClassName} onClick={() => handleDivClick("borrowout")}>{trainData.borrowout}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("current_temp")}>{trainData.current_temp}</div>
      <div className={CannotClickClassName}>{trainData.current_cnt}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("current_use")}>{trainData.current_use}</div>
      ...
      <div className={CanClickClassName} onClick={() => handleDivClick("maintain_w")}>{trainData.maintain_w}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("maintain_sec")}>{trainData.maintain_sec}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("maintain_fac")}>{trainData.maintain_fac}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("oth_waitrep")}>{trainData.oth_waitrep}</div>
      <div className={CanClickClassName} onClick={() => handleDivClick("oth_return")}>{trainData.oth_return}</div>
