...
export const LabelAndNumberByArea = ({
  area_name = "臺北機務段車輛配置",
  onLabelClick,
}: Props): JSX.Element => {
  ...
  return (
    <div className="flex flex-col  pt-4 px-5 relative self-stretch">
      <div
        ...
        className="w-full p-2 cursor-pointer rounded-xl  cursor-pointer transition-transform rounded-xl duration-300 ease-in-out transform hover:scale-105 hover:bg-slate-100"
      >
        {" "}
        -{area_name}
      </div>
